...
export default function LoginScreen() {
  ...
  const users = [
    { email: 'tuanhuu783@gmail.com', password: '1234' },
    { email: 'user1@example.com', password: '1234' },
    { email: 'user2@example.com', password: '4567' },
    { email: 'user3@example.com', password: '7891' },
    { email: 'user4@example.com', password: '1111' },
  ];
  ...
  const handleLogin = () => {
    ...
    if (user) {
      ...
      setLoginError('Tên đăng nhập hoặc mật khấu không đúng!');
      setModalVisible(true); 
    }
  };
